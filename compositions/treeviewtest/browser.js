	...
	this.render = function(){return[
		view({position: "relative",   flexdirection: "column", height: 20, bgcolor: "black", flex:1},[
			...
			,view({position: "relative",   flexdirection: "row", bgcolor: "black", alignitems:"stretch", alignself: "stretch" , flex:1}
				...
				,view({position: "relative", width: 400,  flexdirection: "column", bgcolor: "#808090", alignself: "stretch" , borderwidth: 1, paddingleft:2,cornerradius: "vec4(0,0,14,0)" , bordercolor: "gray" }
					...
					,foldcontainer({title:"Fancy buttons", alignself: "stretch",marginbottom: 2},
						view({flexwrap:"wrap", flex:1, position:"relative", padding: 4, bgcolor: "transparent"},button({text:"I am a button"})
						,button({text:"me too"})
						,button({text:"so am I"})
